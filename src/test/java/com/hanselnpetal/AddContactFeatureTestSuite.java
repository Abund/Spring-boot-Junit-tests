...
public class AddContactFeatureTestSuite {
	...
	//smoke test- tests that basic system health
	//iteration suite- test that are related to project iteration
	//feature suite-test that combine testing of several features
}
